  ...
  const handleDelete = async (itemId: number) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`http://localhost:8000/api/user/${itemId}`);
              ...
              <div className="px-0 row justify-content-beetwen">
                <div className="px-0 col-lg-6">
                  <NavLink to="create" className="btn btn-outline-primary">
                    <i className="bx bx-user-plus"></i>Tambah
                  </NavLink>
                  <RefreshButton />
                </div>

    ...
    <aside
      ...
      <div className="app-brand demo">
        ...
        <a
          ...
          <i className="align-middle bx bx-chevron-left bx-sm" />
        </a>
      </div>
      <div className="menu-inner-shadow" />
      <ul className="py-1 menu-inner">
        <li
          className={`menu-item ${
            "/admin" == currentPath ? "active" : ""
          }`}>
        ...
        {masterDatas.map((item) => (
          <li
            className={`menu-item ${
              item.isActive == currentPath ? "active" : ""
            }`}
            key={item.path}>
        ...
        <li className="menu-header small text-uppercase">
          <span className="menu-header-text">End</span>
        </li>
